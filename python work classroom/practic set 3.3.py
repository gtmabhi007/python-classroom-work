...
a = input("enter string:=")
print("first five character of string",a[:5:])
print("last five character",a[-5:])
print("index from 3 to 10",a[3:11:])
...
a = "I live in ghaziabad"
b = a.replace(" ", "-")
print("replace every space",b)
...
b = a.replace(" ","\n")
print("display every words in next line",b)

# 9. Write a Python program to reverse the order of words in a sentence.
a = ("my name is abhishek gautam ") 
print(a[::-1])
...
print("convert into Uppercase:=", a.upper())

print("convert into Lowercase:=", a.lower())

print("convert into Swap case:=", a.swapcase())

print("convert into Trimmed:=", a.strip())

b = a.replace("Python", "Java")
print("Replaced the value is:=", b)

words = a.split()
print("convert Split into words:", words)

h = "-".join(words)
print("Joined with hyphen:", h)
